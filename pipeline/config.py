...
# 983 tiles containing none of them. All four are open-sea squares (Tyrrhenian
# and Ionian), off the coast rather than on the Apennine spine, so no
# snow-relevant land is lost by dropping them; the same is true of every other
# square missing from HR-WSI's grid nearby (33TXG, 33TYG, 33SUA, 33SXA - all
# sea). Because of this, a tile reported missing by a run is now a real
# anomaly worth failing on rather than expected noise.
